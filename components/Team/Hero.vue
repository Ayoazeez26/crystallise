...
<template>
  <div
    class="pt-20 text-grey px-4 xl:px-0 md:pt-28 w-full"
  >
    <div
      class="w-full max-w-[853px] flex flex-col items-center mx-auto text-center mt-20"
    >
      <p class="text-lg md:text-2xl text-primary font-semibold mb-2">Join Our Team</p>
